...
function LoadDecks() {
  ...
  $("#randomdeck").attr(
    "onclick",
    "window.location.href='decklauncher.html?"+setStr+(viewingPlayer==runner?"r":"c")+"=random';"
  );
  ...
  if (viewingPlayer == runner) {
    ...
    $("#editdeck").attr(
      "onclick",
      "window.location.href='decklauncher.html?p=r&"+setStr+opponentDeckString+"r=" + compressedDeckString + "';"
    );
  }
  ...
  if (viewingPlayer == corp) {
    ...
    $("#editdeck").attr(
      "onclick",
      "window.location.href='decklauncher.html?p=c&"+setStr+opponentDeckString+"c=" + compressedDeckString + "';"
    );
  }
